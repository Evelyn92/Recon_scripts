...
reconDir = '/home/debi/yiwei/recon_results/250314_seq_rfsp/';

ETDir = ['/home/debi/yiwei/recon_results/250314_seq_rfsp/', 'masks/'];
if subject_num == 1
    mask_note = 'rf1_fov480_rfsp';
elseif subject_num == 2
    mask_note = 'rf2_fov480_rfsp';
else
    mask_note = 'rf_rect_fov480_rfsp';
end
...
if subject_num == 1
    bodyCoilFile     = [datasetDir, '/meas_MID00141_FID292456_a0_prescan_BC.dat'];
    arrayCoilFile    = [datasetDir, '/meas_MID00139_FID292454_a0_prescan_HC.dat'];
    measureFile = [datasetDir, '/meas_MID00143_FID292458_a1_rf1.dat'];
elseif subject_num == 2
    bodyCoilFile     = [datasetDir, '/meas_MID00150_FID292465_b0_prescan_BC.dat'];
    arrayCoilFile    = [datasetDir, '/meas_MID00145_FID292460_b0_prescan_HC.dat'];
    measureFile = [datasetDir, '/meas_MID00151_FID292466_b1_rf2.dat'];
elseif subject_num == 3
    bodyCoilFile = [datasetDir, '/meas_MID00153_FID292468_c0_prescan_BC.dat'];
    arrayCoilFile = [datasetDir, '/meas_MID00152_FID292467_c0_prescan_HC.dat'];
    measureFile = [datasetDir, '/meas_MID00154_FID292469_c1_rect_rf.dat'];
else
