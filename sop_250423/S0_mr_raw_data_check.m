...
twix_path =  ['/home/debi/yiwei/mreye_dataset/250423/', twix_name,'.mat'];
...
figure;
nPoints = 10000;
plot(time_ms(1:nPoints), pmu_ext_table.EXT1(1:nPoints))
hold on;
plot(time_ms(1:nPoints), pmu_ext_table.EXT2(1:nPoints))
xlabel('time (ms)')
