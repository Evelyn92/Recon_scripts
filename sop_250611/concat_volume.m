...
bmImage(x4_rot)
%%
[img1, img2] = norm_two_image(x1_rot(range{1}, range{2}, range{3}),x3_rot(range{1}, range{2}, range{3}));
...
loLev = 0.0;upLev = 0.3;[imClip, rgb_vec] = relaxationColorMap('T1', show_diff_image, loLev, upLev);
