...
%%
[img1_trans, img2_trans] = norm_two_image(x1_trans(51:141,60:180,:),x2_trans(51:141,60:180,:));
img_1_2_trans = cat(1,img1_trans, img2_trans);
bmImage(img_1_2_trans)

[img1_sag, img2_sag] = norm_two_image(x1_sag(100:145, 60:150,:),x2_sag(100:145,60:150,:));
...
for slice = (sl_start+inc):inc:sl_end
    show_image = cat(2,[show_image, img1_trans(:,:,slice)]);
end
bmImage(show_image);
