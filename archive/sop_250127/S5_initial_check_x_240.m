...
check_intensity_profile(slice_bin_norm,slice_wobin_norm, xcor,ycor,'bin vs wobin');

%%
diff_map_plot(x_bin_crop, x_wobin_crop, 30)
%%
...
function check_intensity_profile(img1,img2, xcor,ycor,info)
...
figure;
plot(intensityProfile1,'-r', 'DisplayName','bin','LineWidth',2);
hold on;
plot(intensityProfile2,'-b', 'DisplayName','wobin','LineWidth',2);
legend('show');grid on;
