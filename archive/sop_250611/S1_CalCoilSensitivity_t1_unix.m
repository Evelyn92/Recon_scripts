...
% meas_MID00349_FID29964_t1wlibre_TR6p2.dat
% meas_MID00351_FID29966_t1wgre_TR6p2.dat
% meas_MID00350_FID29965_t1wlibre_TR8p01.dat
% meas_MID00352_FID29967_t1wgre_TR8p01.dat
% 
% meas_MID00369_FID29984_T1wLIBRE_TR6p2_brain.dat
% meas_MID00373_FID29988_T1wgre_TR6p2_brain.dat
% meas_MID00370_FID29985_T1wLIBRE_TR8p01_brain.dat
% meas_MID00372_FID29987_T1wgre_TR8p01_brain.dat

%% Initialize the directories and acquire the Coil
for subject_num = [5]
use_C = 0;
%
datasetDir = '/Users/cag/Documents/Dataset/datasets/250611/';
reconDir = '/home/debi/yiwei/recon_results/250611/';



mask_note_list={'fat_libre_6p2','fat_gre_6p2', ...
    'fat_libre_8p01','fat_gre_8p01', ...
    'brain_libre_6p2','brain_gre_6p2', ...
    'brain_libre_8p01','brain_gre_8p01'
    };

mask_note = mask_note_list{subject_num};

if subject_num == 1
    meas_name_suffix = '_MID00349_FID29964_t1wlibre_TR6p2';
    hc_name_suffix = ' ';
    bc_name_suffix = ' ';
    nShot=1000;

elseif subject_num == 2
    meas_name_suffix = '_MID00351_FID29966_t1wgre_TR6p2';
    hc_name_suffix = ' ';
    bc_name_suffix = ' ';
    nShot=1000;

elseif subject_num == 3
    meas_name_suffix = '_MID00350_FID29965_t1wlibre_TR8p01';
    hc_name_suffix = ' ';
    bc_name_suffix = ' ';
    nShot=1000;
elseif subject_num == 4
    meas_name_suffix = '_MID00352_FID29967_t1wgre_TR8p01';
    hc_name_suffix = ' ';
    bc_name_suffix = ' ';
    nShot=1000;

elseif subject_num == 5
    meas_name_suffix = '_MID00369_FID29984_T1wLIBRE_TR6p2_brain';
    hc_name_suffix = ' ';
    bc_name_suffix = ' ';
    nShot=1000;
