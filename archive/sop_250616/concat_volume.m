...
close all;clc
%%
x1 = permute(xlibre1, [2,3,1]);
x2 = permute(xlibre2, [2,3,1]);
x3 = permute(xlibre3, [2,3,1]);
%%
x1 = rot90(x1, 2);
x1_flip = flip(x1,3);
bmImage(x1_flip);
...
bmImage(x3);
%%
x4 = permute(xgre4, [2,3,1]);
x5 = permute(xgre5, [2,3,1]);
x4 = rot90(x4, 2);
x4_flip = flip(x4,3);
bmImage(x4_flip);
bmImage(x5);
...
%%
[img1, img2] = norm_two_image(x1_flip,x2);
% [img1, img2] = norm_two_image(x1_flip,xlibre3);
% [img1, img2] = norm_two_image(xlibre2,xlibre3);
