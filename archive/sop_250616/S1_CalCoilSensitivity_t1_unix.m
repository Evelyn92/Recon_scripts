...
% meas_MID00172_FID304477_JB_LIBRE2p2_a8_woPERewinder.dat
% meas_MID00173_FID304478_yj_seq1_libre_6p2_gain1.dat
% meas_MID00174_FID304479_yj_seq1_libre_6p2_gain0.dat
% meas_MID00175_FID304480_JB_RectPulse_a5_woPERewinder.dat
% meas_MID00176_FID304481_yj_seq1_gre_6p2_gain0.dat
% meas_MID00177_FID304482_JB_T2LIBRE2p2_a8_woPERewinder.dat

%% Initialize the directories and acquire the Coil
subject_num = 2;
use_C = 0;
%
datasetDir = '/Users/cag/Documents/Dataset/datasets/250616/';
reconDir = '/Users/cag/Documents/Dataset/recon_results/250616/';



mask_note_list={'idea_libre_6p2','pulseq_libre_6p2_gain1','pulseq_libre_6p2_gain0', ...
    'idea_gre_TR6p22_TE4p48','pulseq_gre_6p2'};

mask_note = mask_note_list{subject_num};

if subject_num == 1
    meas_name_suffix = '_MID00172_FID304477_JB_LIBRE2p2_a8_woPERewinder';
    hc_name_suffix = ' ';
    bc_name_suffix = ' ';
    nShot=1000;

elseif subject_num == 2
    meas_name_suffix = '_MID00173_FID304478_yj_seq1_libre_6p2_gain1';
    hc_name_suffix = ' ';
    bc_name_suffix = ' ';
    nShot=1000;

elseif subject_num == 3
    meas_name_suffix = '_MID00174_FID304479_yj_seq1_libre_6p2_gain0';
    hc_name_suffix = ' ';
    bc_name_suffix = ' ';
    nShot=1000;
elseif subject_num == 4
    meas_name_suffix = '_MID00175_FID304480_JB_RectPulse_a5_woPERewinder';
    hc_name_suffix = ' ';
    bc_name_suffix = ' ';
    nShot=1000;

elseif subject_num == 5
    meas_name_suffix = '_MID00176_FID304481_yj_seq1_gre_6p2_gain0';
    hc_name_suffix = ' ';
    bc_name_suffix = ' ';
    nShot=1000;

elseif subject_num == 6
    meas_name_suffix = '_MID00373_FID29988_T1wgre_TR6p2_brain';
    hc_name_suffix = ' ';
    bc_name_suffix = ' ';
    nShot=1000;
...
elseif subject_num == 7
    meas_name_suffix = '_MID00370_FID29985_T1wLIBRE_TR8p01_brain';
    hc_name_suffix = ' ';
    bc_name_suffix = ' ';
    nShot=1000;

elseif subject_num == 8
    meas_name_suffix = '_MID00372_FID29987_T1wgre_TR8p01_brain';
    hc_name_suffix = '..';
    bc_name_suffix = '..';
    nShot=1000;
end
...
elseif FoV==480
    FoV = FoV;
    voxel_size = 2;
    disp('recover the FoV to the half')
else
    disp('Error appearing here!')
end
